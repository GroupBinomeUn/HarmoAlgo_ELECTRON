...
function verifyAddPeople() {	
	//###>>>bug lors de l'ajout d'un +-*/... dans le codePostal ou le phone. Cela affiche une erreur sur les deux même si une seule entrée est fausse !!! parseInt(txt.value, 10) pour vérifier si c'est un int
